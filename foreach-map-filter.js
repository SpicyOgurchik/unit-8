...
function doubleValues(arr){
    let arr1 = [];
    arr.forEach(function(value) {arr1.push(value * 2);});
  return arr1;
}
...
/*
Write a function called showFirstAndLast which accepts an array of strings and returns a new array with only the first and last character of 
each string.
...
function showFirstAndLast(arr){
    let arr1 = [];
    arr.forEach(function(value) {
      arr1.push(value[0] + value[value.length - 1]);
    });
    return arr1;
}

/*
Write a function called addKeyAndValue which accepts an array of objects, a key, and a value and returns the array passed to the function with
 the new key and value added for each object 
...
console.log(vowelCount("MEataaarr1eeeeet")) ;
...
/*
Write a function called valTimesIndex which accepts an array and returns a new array with each value multiplied by the index it is currently 
at in the array.
...
/*
Write a function called filterByValue which accepts an array of objects and a key and returns a new array with all the objects that contain 
that key.
...
/*
Write a function called find which accepts an array and a value and returns the first element in the array that has the same value as the second 
...
/*
Write a function called findInObj which accepts an array of objects, a key, and some value to search for and returns the first found value in 
the array.
...
function removeVowels(str) {
    ...
    const vowels = "aeiou";
    return str2.filter(function(value) {
        return vowels.indexOf(value) === -1;
    }).join("");
}
console.log(removeVowels("MEataaarr1eeeeet")) ;
